...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, out_channels, pixel_shuffle_channels=[], use_batchnorm=True, attention_type=None, shuffle_blur=True):
        super().__init__()
        ...
        self.shuffle = PixelShuffle_ICNR(pixel_shuffle_channels, pixel_shuffle_channels, scale=2, blur=shuffle_blur)
